    ...
    public class PostRepository : BaseRepository, IPostRepository
    {
        ...
        public Post GetById(int id)
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                          SELECT p.Title, p.Caption, p.DateCreated, p.ImageUrl, p.UserProfileId, u.[Name], u.email, u.ImageUrl as 'UserProfileImageUrl', u.Bio, u.DateCreated as 'UserProfileDateCreated'
                            FROM Post p
